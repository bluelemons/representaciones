...
describe "entidades/new.html.haml" do
  before(:each) do
    assign(:entidad, stub_model(Entidad,
      :calle => "MyString",
      :cuit => 1,
      :telefono => "MyString",
      :legajo => "MyString",
  ...
  it "renders new entidad form" do
    render

    rendered.should have_selector("form", :action => entidades_path, :method => "post") do |form|
