...
describe AgenciesController do
  ...
  def mock_agency(stubs={})
    @mock_agency ||= mock_model(Agency, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all agencies as @entidads" do
      Agency.stub_chain(:baja, :search) { [mock_agency] }
      Agency.stub(:paginate) { |arg| arg }
      get :index
      assigns(:entidads).should eq([mock_agency])
    end
  end

  describe "GET new" do
    it "assigns a new agency as @entidad" do
      Agency.stub(:new) { mock_agency }
      get :new, :format=> 'js'
      assigns(:entidad).should be(mock_agency)
    end
  end

#  describe "GET show" do
#    it "assigns the requested agency as @entidad" do
...
#        post :create, :agency => {}
#        response.should redirect_to(:controller =>:agencies,:action=>'show',:format=>:js,:id=>mock_agency.id)
#      end
#    end
